...
const columns = computed<DetailTableColumns[]>(() => [
    ...
    { name: 'A', show: store.prospectosFilters.showGteDetails, class: 'text-center etapa-a text-white' },
    { name: 'P', show: store.prospectosFilters.showGteDetails, class: 'text-center etapa-b text-white' },
    { name: 'N', show: store.prospectosFilters.showGteDetails, class: 'text-center etapa-n text-white' },
    { name: 'C', show: store.prospectosFilters.showGteDetails, class: 'text-center etapa-c text-white' },
